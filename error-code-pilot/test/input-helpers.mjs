...
export async function choose(page,id,model){
 ...
 await page.locator('#observable-area').selectOption(s.observable_area);await page.locator('#observed-symptom:visible').waitFor();await page.locator('#observed-symptom').selectOption(id);
}
