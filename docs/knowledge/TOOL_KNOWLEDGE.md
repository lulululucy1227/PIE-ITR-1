...
- Current PIE-confirmed handling for that exact pattern on `1.30.31.10`: select/reflash `1.30.29.24`, then repeat the Functional Test. Similar cases have passed after switching to `1.30.29.24`.
